        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="px-2.5 py-0.5 bg-purple-100 text-purple-700 text-xs font-semibold rounded-full border border-purple-200">
        ...
        <div className="bg-amber-50/70 border border-amber-200/80 rounded-2xl p-4 text-xs text-amber-900 flex items-start gap-3">
          ...
          <div className="space-y-1">
            <div className="font-semibold text-amber-950">
              HIPAA & Clinical Safety Advisory
            </div>
            <p className="text-amber-800 leading-relaxed text-[11px]">
              AI recommendations provided by CentriCare AI are generated via backend-isolated services for clinical decision support. All diagnoses, prescriptions, and therapeutic plans must be critically reviewed and validated by a licensed physician before applying to clinical treatment.
            </p>
          </div>
        </div>
      </div>
